...
if (isset($_SESSION['username'])) {
  $flagChamp = $_SESSION['flagChamp'];
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <title>HomeLog - Godopoli</title>
    <meta property="og:title" content="HomeLog - Godopoli" />
  ...
  <body>
    ...
    <div>
      <link href="./home-log.css" rel="stylesheet" />

      <div class="home-log-container">
        <div class="home-container02">
          <div class="home-log-hero">
            <h1 class="home-log-text">
              <span class="home-log-text1" >Ciao,&nbsp;</span>
              <br />
	...
	<article class="modal-container">
      ...
      <img src="Images/champions.jpg" alt="image" class="home-image2" />
		...
		<footer class="modal-container-footer">
			<button id="fantaChamp" type="button" class="home-button3 button" style="background-color: red; color: white;"><?php if($flagChamp==0) { echo "ISCRIVITI";} else {echo "GIOCA";}?></button>
      <script>
      document.getElementById("fantaChamp").addEventListener("click", function() {
	...
	<article class="modal-container">
      ...
      <img src="Images/ROYAL.jpg" alt="image" class="home-image2"/>
		...
		<footer class="modal-container-footer">
      <button type="button" class="home-button3 button" style="background-color: grey; color: white;">ATTENDI</button>
		</footer>
	</article>
</div>
...
var flagChamp = <?php echo $_SESSION['flagChamp']; ?>;
...
document.getElementById("fantaChamp").addEventListener("click", function() {
  ...
  document.getElementById("fantaChamp").addEventListener("click", function() {
    ...
    window.location.href = "cod.php";
        ...
        <div class="home-log-container07"></div>
        <div class="home-log-container11"></div>
      </div>
    </div>
  </body>
</html>
